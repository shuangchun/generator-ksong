...
var KsoNgFEGenerator = generators.Base.extend({
    ...
    welcome: function() {
        this.log(yosay(
            'Lets build one AngularJS WebApp!'
        ));
    },
    ...
    prompting: function () {
        ...
        this.prompt(prompts, function (answers) {
            ...
            this.appName = this.appName || 'KsoFE'; //path.basename(process.cwd());
            done();
        }.bind(this));
    },

    displayName: function() {
        this.log('Creating ' + this.appName + ' app based on KsoFE.');
    },
...
module.exports = KsoNgFEGenerator;
